...
const downloadUrl = "/downloads/VOS-Founding-Beta-0.16.2-Windows-Setup-R8.exe";
const checksumUrl = "/downloads/VOS-Founding-Beta-0.16.2-Windows-Setup-R8.exe.sha256";
  ...
  return (
    <div className="min-h-full overflow-hidden rounded-[2rem] border border-white/10 bg-[#050711] text-white shadow-2xl">
        ...
        <div className="relative grid items-center gap-12 xl:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-300">
              ...
              operating environment. Version 0.16.2 keeps Browser, Sandbox,
              Shield, and Debugger inside the VOS desktop and gives VOS Sandbox its own
              VOS terminal path, upgrades SV modules instead of retaining stale
              executables, and restores SV Browser and SVANSAI Guide startup handling.
            </p>
      ...
      <footer className="flex flex-col gap-4 border-t border-white/10 px-6 py-7 text-sm text-zinc-500 sm:px-10 md:flex-row md:items-center md:justify-between lg:px-14">
        <span>Vansant Operating Systems · Founding Beta 0.16.2</span>
