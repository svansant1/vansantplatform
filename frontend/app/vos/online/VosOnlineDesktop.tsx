                ...
                {page === "vos" && (
                  <>
                    ...
                    <div className="mt-6 flex flex-wrap gap-3">
                      ...
                      <a href="/downloads/VOS-Founding-Beta-0.15.0-Windows-Setup-R6.exe" download className="inline-flex items-center gap-2 rounded-xl border border-white/15 px-5 py-3 font-bold hover:bg-white/10">
